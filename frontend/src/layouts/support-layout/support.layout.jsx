...
const SupportLayout = () => {
	...
	const [borderStyles, setBorderStyles] = useState("p-6 bg-white/15 rounded-lg shadow-md border border-y-cyan-400 border-x-indigo-400  border-gradient-to-b transition-colors transition-colors duration-200");
